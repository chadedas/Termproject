  ...
  ================================================== -->
    ...
    <div class="row text-center mx-auto">
        ...
        <div class="col-lg-4 ">
            ...
            <p><a class="btn btn-secondary m-auto" href="Product_All.aspx">ข้อมูลเพิ่มเติม »</a></p>
        </div>
        <!-- /.col-lg-4 -->
        ...
        <div class="col-lg-4">
            ...
            <p><a class="btn btn-secondary" href="Product_All.aspx">ข้อมูลเพิ่มเติม »</a></p>
        </div>
        <!-- /.col-lg-4 -->
    </div>
    <!-- /.row -->
    ...
    <div class="row featurette py-5">
        <div class="col-md-7 px-5">
            ...
            <p><a class="btn btn-secondary m-auto" href="Tourist_All.aspx">ข้อมูลเพิ่มเติม »</a></p>
        </div>
        <div class="col-md-5">
