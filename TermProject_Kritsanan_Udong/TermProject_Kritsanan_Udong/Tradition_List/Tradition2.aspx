<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Tradition2.aspx.vb" Inherits="TermProject_Kritsanan_Udong.Tradition2" %>
...
<main class="text-secondary h-100" style="background-color:ghostwhite">
        ...
        <tr class="w-100 h-100 position-relative">
            <td class="h-100 list-group py-3 position-static position-fixed w-auto rounded-0 shadow_nav conta">
              ...
              <a href="Tradition2.aspx" class="list-group-item list-group-item-action active rounded-0">ประเพณีลอยกระทงสาย</a>
    ...
    <table class="w-100 h-100">
        <tr class="w-100 h-100">
            <td class="w-75 h-100 text-center "> 
                <h3 class="py-3">งานประเพณีลอยกระทงสายไหลประทีป ๑๐๐๐ ดวง</h3>
                <h6 class="text-start mx-5 px-5">ประเพณีลอยกระทงสาย ไหลประทีป 1,000 ดวง เป็นหนึ่งในงานลอยกระทงประจำท้องถิ่นที่มีชื่อเสียงของจังหวัดตาก และปฎิบัติสืบเนื่องกันมาอย่างยาวนาน ภาพของกระทงที่ไหลตามแม่น้ำยาวเป็นสายอย่างต่อเนื่อง พร้อมกับแสงไฟระยิบระยับสร้างความประทับใจให้นักท่องเที่ยวเสมอเป็นประจำทุกปี เรามาทำความรู้จักกับที่มาของประเพณีกันดีกว่า ว่ามีเอกลักษณ์ และความพิเศษที่แตกต่างจากงานลองกระทงที่อื่นอย่างไรบ้าง</h4>
                    <h4>จัดขึ้นในวันลอยกระทงเดือนพฤษจิกายนของทุกปี</h4>
                    <img src="../allPicture/Tradition2.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/Tradition2_2.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto w-75 h-75"/>
                    <img src="../allPicture/Tradition2_3.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto w-75 h-75"/>
</div>
        </tr>
    </table>
</div>
