<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Tradition.aspx.vb" Inherits="TermProject_Kritsanan_Udong.Tradition" %>
...
<main class="text-secondary h-100" style="background-color:ghostwhite">
        ...
        <tr class="w-100 h-100 position-relative">
            <td class="h-100 list-group py-3 position-static position-fixed w-auto rounded-0 shadow_nav conta">
              ...
              <a href="Tradition.aspx" class="list-group-item list-group-item-action active rounded-0">ประเพณีขึ้นธาตุเดือน 9</a>
              <a href="Tradition2.aspx" class="list-group-item list-group-item-action rounded-0">ประเพณีลอยกระทงสาย</a>
              <a href="Tradition3.aspx" class="list-group-item list-group-item-action rounded-0">งานตากสินมหาราชานุสรณ์</a>
            </td>
            </tr>
        </table>
    ...
    <table class="w-100 h-100">
        <tr class="w-100 h-100">
            <td class="w-75 h-100 text-center "> 
                <h3 class="py-3">ประเพณีขึ้นธาตุเดือน 9</h3>
                <h6 class="text-start mx-5 px-5">เป็นงานบุญที่จัดขึ้นเพื่อเป็นการบูชาพระบรมธาตุขององค์สมเด็จพระสัมมา สัมพุทธเจ้า กำหนดการจัดในวันขึ้น ๑๔ ค่ำ และ ๑๕ ค่ำ เดือน ๙ ของภาคเหนือ
                    หรือตรงกับเดือน ๗ ของไทย ประมาณปลายเดือนพฤษภาคมหรือเดือนมิถุยายนของทุกปี ภายในงานมีการจัดขบวนแห่ เช่น ขบวนกลองยาว ขบวนปัจจัยไทยทาน สำหรับงานประเพณีขึ้นธาตุเดือนเก้า เป็นประเพณีและวัฒนธรรมอันดีงามประจำถิ่น ซึ่งจัดขึ้นเป็นประจำทุกปี ในช่วงวันขึ้น 14 และ 15 ค่ำเดือนเก้าของทุกปี ซึ่งปีนี้ตรงกับวันที่ 13 มิถุนายน 2565 แต่เนื่องด้วยในปีที่ผ่านๆ มา เกิดสถานการณ์การแพร่ระบาดของโควิด-19 ทำให้มีการงดจัดงานประเพณีดังกล่าว ซึ่งในปีนี้สถานการณ์การแพร่ระบาดได้ผ่อนคลายลงไป จึงได้จัดกิจกรรมขึ้นเพื่อเป็นการอนุรักษ์ไว้ซึ่งประเพณีและวัฒนธรรม ภายใต้มาตรการป้องกันโควิด-19</h6>
                <h4>จัดในช่วงประมาณปลายเดือนพฤษภาคมหรือเดือนมิถุนายนของทุกปี</h4>
                    <img src="../allPicture/Tradition1.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
</div>
        </tr>
    </table>
</div>
