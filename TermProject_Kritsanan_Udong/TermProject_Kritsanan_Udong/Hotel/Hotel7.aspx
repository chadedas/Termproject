<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Hotel7.aspx.vb" Inherits="TermProject_Kritsanan_Udong.Hotel7" %>
        ...
        <tr class="w-100 h-100 position-relative">
            <td class="h-100 list-group py-3 position-static position-fixed w-auto rounded-0 shadow_nav conta">
              ...
              <a href="Hotel3.aspx" class="list-group-item list-group-item-action rounded-0">Baan Chang Hotel</a>
                ...
                <a href="Hotel7.aspx" class="list-group-item list-group-item-action rounded-0 active">Pingview Villa Resort</a>
    ...
    <table class="w-100 h-100">
        <tr class="w-100 h-100">
            <td class="w-75 h-100 text-center "> 
                <h3 class="py-3">Pingview Villa Resort ตาก</h3>
                <h6 class="text-start mx-5 px-5">Pingview Villa Resort ตาก ที่พักเมืองตากแบบรีสอร์ต 3 ดาว อยู่บริเวณย่านตำบลแม่ท้อ บรรยากาศดีติดริมแม่น้ำปิง ห้องพักราคาไม่แพงเป็นส่วนตัวมาก จอดรถสะดวกที่หน้าห้อง แต่ละห้องแยกกัน สะอาดกว้างขวาง อุปกรณ์อำนวยความสะดวกครบ เงียบสงบนอนหลับสบาย พนักงานเป็นกันเอง มี Wi-Fi ฟรี มีจักรยานให้ปั่นฟรี และร้านอาหารริมน้ำ เหมาะมาพักแบบครอบครัวมาก</h6>
                    <img src="../allPicture/hotel7_1.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel7_2.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel7_3.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel7_4.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
...
ที่อยู่ : 102 หมู่ 1 ต.แม่ท้อ อ.เมือง จ.ตาก 63000<br />
เบอร์โทร : 080-044-1133<br /></h6><br />
    </div>
    <div class="col">
                    ...
                    <p class="mx-auto px-auto"><a href="https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=1812163&hl=th&hid=2846360" target="_blank">
                        <img src="../allPicture/agoda-booking-bt-min.png" class="w-25 h-25 mx-auto"/></a>
                        <a href="https://www.booking.com/hotel/th/pingview-villa-resort.th.html?aid=1630953" target="_blank"><img src="../allPicture/booking-bt-min.png" class="w-25 h-25 mx-auto"/></a>
                    </p>
</div>
                <br />
                <br />
                <h6>GPS สำหรับที่พัก</h6>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3818.3018332433176!2d99.11976961486907!3d16.860957088396123!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30ddd9983f1dd525%3A0x7ec23d7b72874428!2sPingview%20Villa%20Resort!5e0!3m2!1sth!2sth!4v1664128616863!5m2!1sth!2sth" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="rounded-5"></iframe></td>
