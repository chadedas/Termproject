<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Hotel8.aspx.vb" Inherits="TermProject_Kritsanan_Udong.Hotel8" %>
        ...
        <tr class="w-100 h-100 position-relative">
            <td class="h-100 list-group py-3 position-static position-fixed w-auto rounded-0 shadow_nav conta">
              ...
              <a href="Hotel3.aspx" class="list-group-item list-group-item-action rounded-0">Baan Chang Hotel</a>
                ...
                <a href="Hotel8.aspx" class="list-group-item list-group-item-action rounded-0 active">BanRai ChernMa Resort</a>
    ...
    <table class="w-100 h-100">
        <tr class="w-100 h-100">
            <td class="w-75 h-100 text-center "> 
                <h3 class="py-3">บ้านไร่เชิญมา รีสอร์ท ตาก</h3>
                <h6 class="text-start mx-5 px-5">บ้านไร่เชิญมา รีสอร์ท ตาก (BanRai ChernMa Resort) บ้านพักสบาย ๆ สีสันสดใสในที่พักแสนผ่อนคลายซึ่งมีคาเฟ่ รวมทั้ง Wi-Fi และที่จอดรถฟรี ที่พักตากในเมืองแบบรีสอร์ต 3 ดาว วิลล่าและบ้านพักแสนผ่อนคลายหลายหลังแห่งนี้ตั้งอยู่ในย่านชุมชนที่แสนร่มรื่นและมีทัศนียภาพงดงาม โดยอยู่ห่างจากตรอกบ้านจีน 3 กม. ห่างจากศาลหลักเมืองสี่มหาราช 5 กม. ราคาถูกดี ห้องสะอาด บรรยากาศสงบร่มรื่นน่าพักผ่อน พนักงานสุภาพบริการดีครับ มีอาหารเช้าฟรี</h6>
                    <img src="../allPicture/hotel8_1.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel8_2.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel8_3.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel8_4.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
...
<h6 class="text-start">ราคา : เริ่มต้น 425 บาท/คืน<br />
ที่อยู่ : 189 ม.6 บ้านน้ำโจน ถ.พหลโยธิน ต.วังหิน อ.เมือง จ.ตาก 63000<br />
เบอร์โทร : 055-893-030<br /></h6><br />
    </div>
    <div class="col">
                    ...
                    <p class="mx-auto px-auto"><a href="https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=1812163&hl=th&hid=338078" target="_blank">
                        <img src="../allPicture/agoda-booking-bt-min.png" class="w-25 h-25 mx-auto"/></a>
                        <a href="https://www.booking.com/hotel/th/a-obanrai-chernma-resort.th.html?aid=1630953" target="_blank"><img src="../allPicture/booking-bt-min.png" class="w-25 h-25 mx-auto"/></a>
                    </p>
</div>
                <br />
                <br />
                <h6>GPS สำหรับที่พัก</h6>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3818.4114274882772!2d99.13015762904611!3d16.855530185271704!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30ddd9a8aa05ed75%3A0x17354f5ad79a3a70!2z4Lia4LmJ4Liy4LiZ4LmE4Lij4LmI4LmA4LiK4Li04LiN4Lih4LiyIOC4o-C4teC4quC4reC4o-C5jOC4lw!5e0!3m2!1sth!2sth!4v1664128646756!5m2!1sth!2sth" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="rounded-5"></iframe></td>
