<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Hotel1.aspx.vb" Inherits="TermProject_Kritsanan_Udong.Hotel" %>
...
<main class="text-secondary h-100" style="background-color:ghostwhite">
        ...
        <tr class="w-100 h-100 position-relative">
            <td class="h-100 list-group py-3 position-static position-fixed w-auto rounded-0 shadow_nav conta">
              ...
              <a href="Hotel1.aspx" class="list-group-item list-group-item-action rounded-0 active">Soho Boutique Hotel</a>
    ...
    <table class="w-100 h-100">
        <tr class="w-100 h-100">
            <td class="w-75 h-100 text-center "> 
                <h3 class="py-3">โซโห บูทีค โฮเทล ตาก</h3>
                <h6 class="text-start mx-5 px-5">โซโห บูทีค โฮเทล ตาก (Soho Boutique Hotel) ห้องพักสุดฮิปบรรยากาศสบาย ๆ ในโรงแรมราคาประหยัดอันแสนเรียบง่ายที่มี Wi-Fi และอาหารเช้าฟรี รวมถึงฟิตเนส ที่พักเมืองตากแบบโรงแรม 4 ดาว ตั้งอยู่ใจกลางอำเภอเมืองตาก โดยใช้เวลาเดินจากตรอกบ้านจีนอันเก่าแก่ 16 นาทีและเดินจากวัดสีตลาราม 19 นาที นอกจากนี้ ยังใช้เวลาเดินจากตลาดนัดกลางคืน 19 นาที ห้องพักสะดวกสบาย สะอาด กว้างขวาง อาหารเช้าหลากหลาย จัดมุมได้น่าทาน เหมาะแก่การแวะนอนพักระหว่างเดินทาง</h6>
                    <img src="../allPicture/hotel1_1.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel1_2.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel1_3.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel1_4.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
...
เบอร์โทร : 055 512 507<br /></h6><br />
    ...
    <div class="col">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3817.955436128219!2d99.12209531486928!3d16.878098888385736!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30ddd9bfbcf432df%3A0x3c3ab983cb270cbb!2z4LmC4LiL4LmC4LirIOC4muC4ueC4l-C4teC4hCDguYLguK7guYDguJfguKU!5e0!3m2!1sth!2sth!4v1664124642407!5m2!1sth!2sth" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="rounded-5"></iframe>
            </td>
