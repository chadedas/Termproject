<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Hotel4.aspx.vb" Inherits="TermProject_Kritsanan_Udong.Hotel4" %>
        ...
        <tr class="w-100 h-100 position-relative">
            <td class="h-100 list-group py-3 position-static position-fixed w-auto rounded-0 shadow_nav conta">
              ...
              <a href="Hotel3.aspx" class="list-group-item list-group-item-action rounded-0">Baan Chang Hotel</a>
                <a href="Hotel4.aspx" class="list-group-item list-group-item-action rounded-0 active">Viangtak Riverside Hotel</a>
    ...
    <table class="w-100 h-100">
        <tr class="w-100 h-100">
            <td class="w-75 h-100 text-center "> 
                <h3 class="py-3">โรงแรมเวียงตาก ริเวอร์ไซด์</h3>
                <h6 class="text-start mx-5 px-5">โรงแรมเวียงตาก ริเวอร์ไซด์ (Viangtak Riverside Hotel) โรงแรมเรียบง่ายที่มีไนท์คลับ ร้านอาหาร คาราโอเกะ สระว่ายน้ำกลางแจ้ง และอาหารเช้าฟรี ที่พักตากในเมืองแบบโรงแรม 3 ดาว โรงแรมเก่าแก่ของเมืองตากตั้งอยู่ใจกลางเมืองติดริมแม่น้ำปิง มองเห็นวิวแม่น้ำปิงได้ อยู่ห่างจากวัดมณีบรรพตวรวิหารและหาดทรายทองแม่ปิงเมืองตาก 2 กม. ห้องพักสะอาด ตกแต่งหรูดูดี อุปกรณ์ครบครัน พนักงานอัธยาศัยดี วิวและบรรยากาศรอบข้างดี คุ้มค่ากับเงินที่จ่ายไป อาหารเช้าก็หลากหลาย</h6>
                    <img src="../allPicture/hotel4_1.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel4_2.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel4_3.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel4_4.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
...
เบอร์โทร : 055-512-507<br /></h6><br />
    ...
    <div class="col">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3818.0748519732874!2d99.12093901486917!3d16.87219138838924!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30ddd995613bc8f5%3A0x1c77719d6469e158!2z4LmC4Lij4LiH4LmB4Lij4Lih4LmA4Lin4Li14Lii4LiH4LiV4Liy4LiB4Lij4Li04LmA4Lin4Lit4Lij4LmM4LmE4LiL4LiU4LmM!5e0!3m2!1sth!2sth!4v1664128527437!5m2!1sth!2sth" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="rounded-5"></iframe>
            </td>
