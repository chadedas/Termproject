<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Hotel9.aspx.vb" Inherits="TermProject_Kritsanan_Udong.Hotel9" %>
        ...
        <tr class="w-100 h-100 position-relative">
            <td class="h-100 list-group py-3 position-static position-fixed w-auto rounded-0 shadow_nav conta">
              ...
              <a href="Hotel3.aspx" class="list-group-item list-group-item-action rounded-0">Baan Chang Hotel</a>
                ...
                <a href="Hotel9.aspx" class="list-group-item list-group-item-action rounded-0 active">Domethong Residence</a>
            </td>
            </tr>
        </table>
    ...
    <table class="w-100 h-100">
        <tr class="w-100 h-100">
            <td class="w-75 h-100 text-center "> 
                <h3 class="py-3">โดมทอง เรสซิเดนซ์ ตาก</h3>
                <h6 class="text-start mx-5 px-5">โดมทอง เรสซิเดนซ์ ตาก (Domethong Residence) ห้องพักเรียบง่ายพร้อมระเบียงในโรงแรมเรียบง่ายที่มีที่จอดรถฟรี ที่พักเมืองตากแบบโรงแรม 2 ดาว เป็นที่พักราคาประหยัด เริ่มต้นแค่ 400 บาท ภายในห้องสะอาดนอนหลับสบาย การเดินทางสะดวก มี Wi-Fi ฟรี ที่จอดรถ นำสัตว์เลี้ยงเข้าพักได้ ตอนเช้ามีอาหาร ขนมปังปิ้ง กับโอวัลติน กาแฟ เหมาะกับแวะพักระหว่างเดินทาง</h6>
                    <img src="../allPicture/hotel9_1.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel9_2.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel9_3.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
...
<h6 class="text-start">ราคา : เริ่มต้น 400 บาท/คืน<br />
ที่อยู่ : 159-2 หมู่ 11 ต.น้ำรึม อ.เมืองตาก จ.ตาก 63000<br />
เบอร์โทร : 055-512-548<br /></h6><br />
    </div>
    <div class="col">
                    ...
                    <p class="mx-auto px-auto"><a href="https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=1812163&hl=th&hid=547210" target="_blank">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3818.1669177997433!2d99.13451121536654!3d16.867635522025033!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30ddd9b72d9f1a19%3A0xd10032164e7a0d14!2z4LmC4LiU4Lih4LiX4Lit4LiHIOC5gOC4o-C4quC4i-C4tOC5gOC4lOC4meC4i-C5jA!5e0!3m2!1sth!2sth!4v1664128666437!5m2!1sth!2sth" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="rounded-5"></iframe></td>
