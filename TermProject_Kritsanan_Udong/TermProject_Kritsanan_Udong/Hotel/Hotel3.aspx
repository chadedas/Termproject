<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Hotel3.aspx.vb" Inherits="TermProject_Kritsanan_Udong.Hotel3" %>
...
<main class="text-secondary h-100" style="background-color:ghostwhite">
        ...
        <tr class="w-100 h-100 position-relative">
            <td class="h-100 list-group py-3 position-static position-fixed w-auto rounded-0 shadow_nav conta">
              ...
              <a href="Hotel3.aspx" class="list-group-item list-group-item-action rounded-0 active">Baan Chang Hotel</a>
    ...
    <table class="w-100 h-100">
        <tr class="w-100 h-100">
            <td class="w-75 h-100 text-center "> 
                <h3 class="py-3">Baan Chang Hotel & Coffee House ตาก</h3>
                <h6 class="text-start mx-5 px-5">Baan Chang Hotel & Coffee House ตาก ห้องพักที่ตกแต่งอย่างเรียบง่ายในโรงแรมบรรยากาศสบาย ๆ ที่มีคาเฟ่รวมถึง Wi-Fi และอาหารเช้าฟรี ที่พักตากในเมืองแบบโรงแรม 3 ดาว ใช้เวลาเดินเพียง 9 นาทีจากมหาวิทยาลัยเทคโนโลยีราชมงคลล้านนา เป็นที่พักที่ราคาไม่แพง พนักงาน รปภ.บริการดี ห้องพักสะอาดคุ้มค่า เหมาะเป็นที่พักระหว่างเดินทาง อยู่ติดถนนหาง่าย อยู่ใกล้แหล่งของกินมากมาย ที่จอดรถก็สะดวกสบาย</h6>
                    <img src="../allPicture/hotel3_1.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel3_2.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel3_3.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel3_4.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
...
<h6 class="text-start">ราคา : เริ่มต้น 535 บาท/คืน<br />
ที่อยู่ : 88/8-9 หมู่ 6 ถนนพหลโยธิน ต.ไม้งาม อ.มือง จ.ตาก 63000<br />
เบอร์โทร : 055-512-981<br /></h6><br />
    </div>
    <div class="col">
                    ...
                    <p class="mx-auto px-auto"><a href="https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=1812163&hl=th&hid=6495331" target="_blank">
                        <img src="../allPicture/agoda-booking-bt-min.png" class="w-25 h-25 mx-auto"/></a>
                        <a href="https://www.booking.com/hotel/th/baan-chang-amp-coffee-house.th.html?aid=1630953" target="_blank"><img src="../allPicture/booking-bt-min.png" class="w-25 h-25 mx-auto"/></a>
                    </p>
</div>
                <br />
                <br />
                <h6>GPS สำหรับที่พัก</h6>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4539.921525062023!2d99.12602586858806!3d16.895485839305508!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30ddd9be4f59afd7%3A0xe9e06311d405aed3!2sBaan%20Chang%20Hotel%20%26%20Coffee%20House!5e0!3m2!1sth!2sth!4v1664126760186!5m2!1sth!2sth" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="rounded-5"></iframe>
            </td>
