<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Hotel5.aspx.vb" Inherits="TermProject_Kritsanan_Udong.Hotel5" %>
        ...
        <tr class="w-100 h-100 position-relative">
            <td class="h-100 list-group py-3 position-static position-fixed w-auto rounded-0 shadow_nav conta">
              ...
              <a href="Hotel3.aspx" class="list-group-item list-group-item-action rounded-0">Baan Chang Hotel</a>
                ...
                <a href="Hotel5.aspx" class="list-group-item list-group-item-action rounded-0 active">Berich Hotel</a>
    ...
    <table class="w-100 h-100">
        <tr class="w-100 h-100">
            <td class="w-75 h-100 text-center "> 
                <h3 class="py-3">โรงแรมบีริช, ตาก</h3>
                <h6 class="text-start mx-5 px-5">โรงแรมบีริช, ตาก (Berich Hotel) ห้องพักที่ตกแต่งอย่างเรียบง่ายในโรงแรมราคาประหยัดแบบสบาย ๆ ที่มีคาเฟ่แบบเปิดโล่งบรรยากาศเป็นกันเอง ที่พักเมืองตากแบบโรงแรม 3 ดาว โรงแรมเรียบง่ายราคาประหยัดที่อยู่ใกล้ทางหลวงหมายเลข 12 แห่งนี้ ใช้เวลาเดินจากศาลสมเด็จพระเจ้าตากสินมหาราช 6 นาที เป็นอีกหนึ่งที่พักที่คุ้มราคา ห้องพักสะอาด ห้องน้ำกว้าง น้ำไหลแรง พนักงานบริการด้วยความสุภาพเป็นกันเองมาก สถานที่หาง่ายเดินทางได้สะดวก มีอาหารเช้าฟรี และ Wi-Fi ฟรี</h6>
                    <img src="../allPicture/hotel5_1.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel5_2.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel5_3.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
                    <img src="../allPicture/hotel5_4.jpg" class=" bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto px-auto py-4 w-75 h-75"/>
...
<h6 class="text-start">ราคา : เริ่มต้น 630 บาท/คืน<br />
ที่อยู่ : 2/4 ถนนมหาดไทยบำรุง ต.หนองลวก อ.เมือง จ.ตาก 63000<br />
เบอร์โทร : 082-444-6242<br /></h6><br />
    </div>
    <div class="col">
                    ...
                    <p class="mx-auto px-auto"><a href="https://www.agoda.com/partners/partnersearch.aspx?pcs=1&cid=1812163&hl=th&hid=1572517" target="_blank">
                        <img src="../allPicture/agoda-booking-bt-min.png" class="w-25 h-25 mx-auto"/></a>
                        <a href="https://www.booking.com/hotel/th/berich.th.html?aid=1630953" target="_blank"><img src="../allPicture/booking-bt-min.png" class="w-25 h-25 mx-auto"/></a>
                    </p>
</div>
                <br />
                <br />
                <h6>GPS สำหรับที่พัก</h6>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3817.8454298449396!2d99.12035671536678!3d16.883539121583084!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30ddd9e80cc7ea51%3A0x3b0a358403f695ad!2sBerich%20Hotel!5e0!3m2!1sth!2sth!4v1664128554584!5m2!1sth!2sth" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="rounded-5"></iframe>
            </td>
