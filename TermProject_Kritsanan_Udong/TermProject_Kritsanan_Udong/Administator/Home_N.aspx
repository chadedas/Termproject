...
<div id="carouselExampleIndicators" class="carousel slide mx-auto my-auto" data-bs-ride="true">
  ...
  <!-- Wrap the rest of the page in another container to center all the content. -->
    ...
    <h2 class="py-3 fw-bold">ผลิตภัณฑ์ตำบล</h2>
        ...
        <p><asp:Button ID="Button3" runat="server" Text="แก้ไขข้อมูลส่วนนี้" CssClass="btn1 btn btn-danger m-auto text-center"/></p>
      </div><!-- /.col-lg-4 -->
      ...
      <div class="col-lg-4">
        ...
        <p><asp:Button ID="Button2" runat="server" Text="แก้ไขข้อมูลส่วนนี้" CssClass="btn1 btn btn-danger m-auto text-center"/></p>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4">
        ...
        <p><asp:Button ID="Button1" runat="server" Text="แก้ไขข้อมูลส่วนนี้" CssClass="btn1 btn btn-danger m-auto text-center"/></p>
      </div><!-- /.col-lg-4 -->
    ...
    <div class="row featurette py-5">
      <div class="col-md-7 px-5">
        ...
        <p><asp:Button ID="Button4" runat="server" Text="แก้ไขข้อมูลส่วนนี้" CssClass="btn1 btn btn-danger m-auto text-center"/></p>
      </div>
      <div class="col-md-5">
    ...
    <div class="row featurette py-5">
      ...
      <p><asp:Button ID="Button5" runat="server" Text="แก้ไขข้อมูลส่วนนี้" CssClass="btn1 btn btn-danger m-auto text-center"/></p>
      </div>
    ...
    <div class="row featurette py-5">
      <div class="col-md-7 px-5">
        ...
        <p class="lead">
          ...
          <p><asp:Button ID="Button6" runat="server" Text="แก้ไขข้อมูลส่วนนี้" CssClass="btn1 btn btn-danger m-auto text-center"/></p>
      </div>
      <div class="col-md-5">
