<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ProductReport.aspx.vb" Inherits="TermProject_Kritsanan_Udong.ProductReport" %>
...
<div class=" container marketing rounded-1 px-2" style="background-color:white">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Database1ConnectionString %>" SelectCommand="SELECT Product_Type, COUNT(Product_ID) AS Expr1 FROM Product GROUP BY Product_Type"></asp:SqlDataSource>
