<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TravelingPlace_Add.aspx.vb" Inherits="TermProject_Kritsanan_Udong.TravelingPlace_Add" %>
...
<div class="form-floating py-2">
<asp:TextBox ID="TextBox4" placeholder="ประเภท" runat="server" CssClass="form-control was-validated" aria-describedby="passwordHelpBlock"></asp:TextBox>
<label for="TextBox4" class="form-label">ประเภท</label>
</div>
          <div class="form-floating py-2">
<asp:TextBox ID="TextBox5" placeholder="รายละเอียด" runat="server" CssClass="form-control was-validated" aria-describedby="passwordHelpBlock"></asp:TextBox>
<label for="TextBox5" class="form-label">รายละเอียด</label>
</div>
