<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ProductList.aspx.vb" Inherits="TermProject_Kritsanan_Udong.ProductList" %>
...
<div class=" container marketing rounded-1 px-2" style="background-color:white">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Product_ID" DataSourceID="SqlDataSource2" CssClass="w-100 h-100 table col">
        <Columns>
            ...
            <asp:BoundField DataField="Product_Details" HeaderText="รายละเอียดสินค้า" SortExpression="Product_Details" />
            <asp:BoundField DataField="Product_Type" HeaderText="ประเภทสินค้า" SortExpression="Product_Type" />
            <asp:ButtonField ButtonType="Button" HeaderText="แก้ไขข้อมูล" Text="Button" CommandName="User_Edit1" />
        </Columns>
    </asp:GridView>
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Database1ConnectionString %>" SelectCommand="SELECT * FROM [Product]"></asp:SqlDataSource>
    ...
    <div class="py-5 text-center"><asp:Button ID="Button2" runat="server" Text="เพิ่มผลิตภัณฑ์ชุมชน" CssClass="btn btn-primary mx-3 border-0 align-content-center mx-3 py-2"/><asp:Button ID="Button3" runat="server" Text="กราฟ" CssClass="btn btn-primary mx-3 border-0 align-content-center mx-auto py-2"/></div>
    <!-- /END THE FEATURETTES -->
