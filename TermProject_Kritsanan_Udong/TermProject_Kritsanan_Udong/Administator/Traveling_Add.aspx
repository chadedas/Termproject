<%@ Page Title="" ValidateRequest="false" Language="vb" AutoEventWireup="false" MasterPageFile="~/AdminPage.Master" CodeBehind="Traveling_Add.aspx.vb" Inherits="TermProject_Kritsanan_Udong.Traveling_Add" %>
        ...
        <div class="col-md-7 order-md-2 px-5">
            <center>
                <div class="text-center rounded-5 my-3 align-content-center" style="width: 400px; height: auto">
                    <asp:Image ID="Image1" runat="server" CssClass="rounded-5 w-100 h-100 " ImageUrl="https://img.kapook.com/u/2021/sutasinee/07/a1_1.jpg"/>
                </div>
            </center>
          ...
          <div class="form-floating py-0">
            ...
            <div class="form-floating py-0">
                ...
                <div class="text-center">
                    <asp:Button ID="saveing1" runat="server" Text="เพิ่มสถานที่" CssClass="mx-2 btn btn2 btn-success" />
