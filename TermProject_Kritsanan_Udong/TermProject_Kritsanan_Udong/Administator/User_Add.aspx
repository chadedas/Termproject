<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/AdminPage.Master" CodeBehind="User_Add.aspx.vb" Inherits="TermProject_Kritsanan_Udong.User_Add" %>
          ...
          <div class="form-floating py-0">
            ...
            <div class="form-floating py-0">
                ...
                <div class="text-center">
                    <asp:Button ID="saveing1" runat="server" Text="เพิ่มผู้ใช้" CssClass="mx-2 btn btn2 btn-success" />
