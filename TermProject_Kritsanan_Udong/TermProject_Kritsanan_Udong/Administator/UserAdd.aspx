<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UserAdd.aspx.vb" Inherits="TermProject_Kritsanan_Udong.UserAdd1" %>
...
<asp:TextBox ID="TextBox3" placeholder="ชื่อผู้ใช้" runat="server" CssClass="form-control was-validated" aria-describedby="usernameHelpBlock"></asp:TextBox>
<label for="TextBox3" class="form-label">ชื่อผู้ใช้</label>
</div>
<div class="form-floating py-2">
<asp:TextBox ID="TextBox4" placeholder="รหัสผ่าน" runat="server" CssClass="form-control was-validated" aria-describedby="passwordHelpBlock"></asp:TextBox>
<label for="TextBox4" class="form-label">รหัสผ่าน</label>
</div>
          <div class="form-floating py-2">
<asp:TextBox ID="TextBox5" placeholder="ประเภทผู้ใช้" runat="server" CssClass="form-control was-validated"></asp:TextBox>
<label for="TextBox5" class="form-label">ประเภทผู้ใช้</label>
</div>
          <div class="form-floating py-2">
<asp:TextBox ID="TextBox6" placeholder="ชื่อและนามสกุล" runat="server" CssClass="form-control was-validated"></asp:TextBox>
<label for="TextBox6" class="form-label">ชื่อ-นามสกุล</label>
</div>

<div class="form-floating py-2">
<asp:TextBox ID="TextBox7" placeholder="เบอร์โทร" runat="server" CssClass="form-control was-validated" TextMode="Phone"></asp:TextBox>
<label for="TextBox7" class="form-label">เบอร์โทร</label>

          <div class="py-3 text-center"><asp:Button ID="Button2" runat="server" Text="เพิ่มข้อมูล" CssClass="btn btn-primary mx-3 border-0"/></div>
