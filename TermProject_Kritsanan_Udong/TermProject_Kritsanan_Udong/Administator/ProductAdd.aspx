<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ProductAdd.aspx.vb" Inherits="TermProject_Kritsanan_Udong.ProductAdd" %>
...
<label for="TextBox3" class="form-label">ชื่อผลิตภัณฑ์</label>
</div>
<div class="form-floating py-2">
...
<label for="TextBox4" class="form-label">รายละเอียด</label>
          ...
          <div class="form-floating py-2">
<asp:TextBox ID="TextBox5" placeholder="ประเภทสินค้า" runat="server" CssClass="form-control was-validated" aria-describedby="passwordHelpBlock"></asp:TextBox>
<label for="TextBox5" class="form-label">ประเภทสินค้า</label>
</div>
